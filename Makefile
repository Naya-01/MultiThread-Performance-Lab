...
build: build_writer_reader_tatas build_producer_consumer_tatas build_philosophers_tatas build_posix build_tas build_tatas
...
build_writer_reader_tatas: writer_reader.c verrou_tatas.o mysemaphore.o
	$(CC) $(CFLAGS) -o writer_reader_tatas writer_reader.c verrou_tatas.o mysemaphore.o -lpthread -lrt

build_producer_consumer_tatas: producer_consumer.c verrou_tatas.o mysemaphore.o
	$(CC) $(CFLAGS) -o producer_consumer_tatas producer_consumer.c verrou_tatas.o mysemaphore.o -lpthread -lrt

build_philosophers_tatas: philosophers.c verrou_tatas.o
	$(CC) $(CFLAGS) -o philosophers_tatas philosophers.c verrou_tatas.o -lpthread -lrt
...
build_tatas: test_and_set.c verrou_tatas.o
	$(CC) $(CFLAGS) -o test_and_test_and_set test_and_set.c verrou_tatas.o -lpthread -lrt
